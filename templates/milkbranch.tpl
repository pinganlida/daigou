...
<table width="100%" align="center">
			...
			<tr>
				...
				<td class="milkpowderbranch">
				<a href="./product.php?category=milkpowder&branch=bellamy">{$milkbranch.bellamy}</a>
				</td>
				<td class="milkpowderbranch">
				<a href="./product.php?category=milkpowder&branch=s26">{$milkbranch.s26}</a>
				</td>
				<td class="milkpowderbranch">
				...
				<td class="milkpowderbranch">
				<a href="./product.php?category=milkpowder&branch=nestle">{$milkbranch.nestle}
				</a></td>
				<td class="milkpowderbranch">
				<a href="./product.php?category=milkpowder&branch=diploma">{$milkbranch.diploma}
				</a></td>
				<td class="milkpowderbranch">
				<a href="./product.php?category=milkpowder&branch=ozfarm">{$milkbranch.ozfarm}
				</a></td>
			</tr>	
		</table>
		<br>